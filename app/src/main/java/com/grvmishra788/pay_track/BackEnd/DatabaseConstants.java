...
public class DatabaseConstants {
    ...
    public static final String[] CATEGORIES_COLUMN_NAMES = {
            CATEGORIES_TABLE_COL_CATEGORY_NAME, CATEGORIES_TABLE_COL_ACCOUNT_NAME, CATEGORIES_TABLE_COL_DESCRIPTION
    };

    public static final String[] SUB_CATEGORIES_COLUMN_NAMES = {
            SUB_CATEGORIES_TABLE_COL_CATEGORY_NAME, SUB_CATEGORIES_TABLE_COL_ACCOUNT_NAME, SUB_CATEGORIES_TABLE_COL_DESCRIPTION,
